...
#[inline(always)]
fn load_branch_name() -> meltos_tvn::error::Result<String> {
    Ok(load_configs()?.user_id.0)
}

#[inline(always)]
fn load_configs() -> meltos_tvn::error::Result<SessionConfigs> {
...
#[inline(always)]
fn save_configs(configs: &SessionConfigs) -> meltos_tvn::error::Result {
