...
//     async fn create_dir() {
//         let fs = node_fs();
//         fs.create_dir("src1").await.unwrap();
//         let dir = fs.read_dir("src1");
//         fs.delete("src1").await.unwrap();
//         assert!(dir.await.unwrap().is_some());
//     }
//
//     #[wasm_bindgen_test]
//     async fn create_dir_recursive() {
//         let fs = node_fs();
//         fs.create_dir("sample/src").await.unwrap();
//         let dir = fs.read_dir("sample/src");
//         fs.delete("sample/src").await.unwrap();
//         assert!(dir.await.unwrap().is_some());
//     }
//
//     #[wasm_bindgen_test]
//     async fn success_if_already_created_dir() {
//         let fs = node_fs();
//         fs.create_dir("src2").await.unwrap();
//         fs.create_dir("src2").await.unwrap();
//
//         fs.delete("src2").await.unwrap();
//     }
//
//     #[wasm_bindgen_test]
//     async fn success_if_not_found() {
//         let fs = node_fs();
//
//         fs.delete("src3").await.unwrap();
//         fs.delete("src3").await.unwrap();
//     }
//
//     #[wasm_bindgen_test]
//     async fn write_file_below_root() {
//         let fs = node_fs();
//
...
//
//     #[wasm_bindgen_test]
//     async fn write_file_below_src() {
//         let fs = node_fs();
//         fs.delete("src4").await.unwrap();
//         fs.write_file("src4/hello.txt", b"hello").await.unwrap();
//         let buf = fs.read_file("src4/hello.txt").await.unwrap();
//         assert_eq!(buf, Some(b"hello".to_vec()));
//
//         fs.write_file("src4/hello2.txt", b"hello").await.unwrap();
//         let buf = fs.read_file("src4/hello2.txt").await.unwrap();
//         assert_eq!(buf, Some(b"hello".to_vec()));
//
//         fs.delete("src4").await.unwrap();
//     }
...
//     async fn stat_file() {
//         let fs = node_fs();
//         fs.write_file("src5/hello.txt", b"hello").await.unwrap();
//         let stat1 = fs.stat("src5/hello.txt").await.unwrap().unwrap();
//         assert!(stat1.is_file());
//
//         fs.write_file("src5/hello.txt", b"hello world!").await.unwrap();
//
//         let stat2 = fs.stat("src5/hello.txt").await.unwrap().unwrap();
...
//     async fn stat_dir() {
//         let fs = node_fs();
//         fs.delete("src7").await.unwrap();
//         fs.write_file("src7/hello.txt", b"hello").await.unwrap();
//         let stat1 = fs.stat("src7").await.unwrap().unwrap();
//         assert!(!stat1.is_file());
//         fs.write_file("src7/hello2.txt", b"hello world!").await.unwrap();
//
//         let stat2 = fs.stat("src7").await.unwrap().unwrap();
//         assert_eq!(stat1.create_time, stat2.create_time);
