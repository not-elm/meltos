...
mod tests {
    ...
    use crate::api::test_util::{http_open_room, MockServerClient, owner_session_id};
    use crate::app;
    ...
    async fn success() {
        ...
        stage::Stage::new(BranchName::main(), mock.clone()).execute(".").unwrap();
        ...
        operation::push::Push::new(BranchName::main(), mock.clone()).execute(&mut sender).await.unwrap();
    }
}